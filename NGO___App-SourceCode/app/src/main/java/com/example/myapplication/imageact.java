...
//        mButtonNear = findViewById(R.id.nearby);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Icon").child(ngoEmail);
...
//        mStorageReference = mStorage.getReference();//.child(ngoEmail);
        mDatabaseRef= FirebaseDatabase.getInstance(ngoApp).getReference("NgoDetails").child(ngoEmail);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    mDatabaseRef.child("url").setValue(uri.toString());
