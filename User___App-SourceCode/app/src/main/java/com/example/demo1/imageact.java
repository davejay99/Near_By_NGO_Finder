...
public class imageact extends AppCompatActivity {
    ...
    private String ngoEmail="sattvik-gmail-com";
    @Override
    protected void onCreate(Bundle savedInstanceState){
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("NgoDatabase/Gallery").child(ngoEmail);
        mDatabaseRef= FirebaseDatabase.getInstance().getReference("NgoDatabase/Gallery");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if(mUploadTask!=null && mUploadTask.isInProgress()){
                    Toast.makeText(imageact.this,"Upload in Progress",Toast.LENGTH_SHORT).show();
                }
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                                                    ...
                                                                                    public void onSuccess(Uri uri) {
                                                                                        mDatabaseRef.child(ngoEmail).child(String.valueOf(System.currentTimeMillis())).setValue(uri.toString());
...
//                            mDatabaseRef.child(ngoEmail).child("url").setValue(upload.getmImageUrl());
        ...
        else Toast.makeText(imageact.this,"No File Selected",Toast.LENGTH_SHORT).show();
    }
}
